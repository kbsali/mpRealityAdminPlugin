    ...
    <div class="sf_admin_filter_content">
      ...
      <form action="[?php echo url_for('<?php echo $this->getUrlForAction('collection') ?>', array('action' => 'filter')) ?]" method="post">
        ...
        <div class="sf_admin_form_row">
          <div class="label">&nbsp;</div>
          <div class="field">
            [?php echo link_to(__('Reset', array(), 'sf_admin'), '<?php echo $this->getUrlForAction('collection') ?>', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'blocFilter_reset graybutton f_left')) ?]
